...
public class ListaDeComprasAdapter extends ArrayAdapter<Vendas4> {

    private static final String TAG ="ListaDeComprasDoUsuario";
    private Context mContext;
    int mResource;


    public ListaDeComprasAdapter(Context context, int resource, ArrayList<Vendas4> lista_de_vendas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tituloTextPonto = (TextView) convertView.findViewById(R.id.tipo_de_ponto);
        TextView quantidade_pontos = (TextView) convertView.findViewById(R.id.quantidade_de_pontos_da_venda);
        TextView valor_venda = (TextView) convertView.findViewById(R.id.preco_da_compra_realizada);
        TextView vendedor = (TextView) convertView.findViewById(R.id.nome_do_vendedor);
